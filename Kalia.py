...
BOT_TOKEN = "8033627387:AAHZ9i80-2q3WCKK-wI9oZxk_Sj492zak9g"

# Admin password for /pass command
ADMIN_PASSWORD = "LIZARDOFC"
...
async def bgmi(update: Update, context: CallbackContext):
    ...
    if user_id not in user_access:
        await update.message.reply_text("⚠️ You don't have access. Please pay ₹100 for 5 days access using /pay. CONTACT @Lizardcheatsowner")
        return
